...
/**
 * Note: Most of the stuff below is taken from the react typings:
 * https://github.com/DefinitelyTyped/DefinitelyTyped/blob/b7ebd9c00eba1d557aac93d3e8b6d93c10b59a1a/react/index.d.ts
 *
 * I.e. the authors of these typings deserve our credits.
 *
 * TODO: We need to figure out if these typings have to be adopted further in terms of Infernojs, and if that's the case, in which way.
 */
